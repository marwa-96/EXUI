...
$(document).ready(function(){
    ...
    $('.tile').append('<img class="tilehover" src="../content/dist/img/tilehover.png" alt=" "/>');
	...
	$(".toggle-button").click(function(){
		...
		$(this).children('.toggle-indicator').text($(this).children('.toggle-indicator').text() == '-Who Is Khalifa Computer Group-' ? ' ' : ' ');
	});
