...
(function ( $ ) {
	$.fn.dateDropper = function( options ) {
		...
		$(window).on('resize',function(){
			dd_inner.css({
				'top':dd_input.offset().top+(dd_input.height()-188),
