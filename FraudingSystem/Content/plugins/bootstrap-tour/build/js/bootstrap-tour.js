  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group nextPrev"> <button class="btn btn-sm btn-default" data-role="prev">' + LocalResource("General_Prev") + '</button> <button class="btn btn-sm btn-default" data-role="next">' + LocalResource("General_Next") + '</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-default endTour" data-role="end" onclick="endTour()">' + LocalResource("General_EndTour") + '</button> </div> </div>',
